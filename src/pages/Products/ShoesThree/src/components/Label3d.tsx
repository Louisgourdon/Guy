  ...
  return (
    ...
    >
      <img
        ...
        alt="Déplacer l'article pour voir en réalité augmentée"
        style={{ width: 32, height: 32 }}
      />
      <h3 style={{ fontFamily: "Roboto Slab", fontSize: 16, fontWeight: 300 }}>Déplacer larticle pour voir en réalité augmentée</h3>
    </div>
  );
};
